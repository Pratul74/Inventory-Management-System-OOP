...
if __name__=="__main__":
    ...
    while switch_on:
        ...
        if user.upper()=="F":
            ...
            p_quantity=int(input(f"Enter the quantity of {p_name}: "))
            ...
            if user_answer.upper()=="A":
                ...
                product_name=input("Enter the product name you want to Add the stock of: ")
                additional_quantity=int(input("Enter new quantity you want to add in inventory: "))
            ...
            product_name=input("Enter the product name you want to Delete from Inventory: ")
            success=newInventory.delete_product(product_name=product_name)
            if success:
